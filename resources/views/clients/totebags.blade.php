            ...
            <div class="col-md-10">
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-item active">
                            <img src="imageelements/banners/banner tote bags.jpg" class="d-block w-100" alt="...">
                        </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <h2 style="color:white;" class="text-center font-weight-bold m-4">T O T E B A G S</h2>
